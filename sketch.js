var bananaImage, obstacleImage, obstacleGroup, backgRound, loadAnimation, ground, player_running, player;
...
function draw() {
  ...
  if(World.frameCount % 80 === 0){
    var banana = createSprite(200,randomNumber(120,200),20,20);
